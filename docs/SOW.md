...
- 2026-06-07: WP-2 data layer — schema migrations 0001–0004 (service, signal, incident, incident_event) + Kysely types in packages/db (DEC-010), on the spike-proven client/OCC. Planned: scheduled Lambda to run the failover/consistency/latency claims continuously (WP-9/WP-11).
